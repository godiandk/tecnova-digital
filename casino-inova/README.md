...
Três rodando sempre: **Corrida do Dia**, **Semana das Mesas** (só os jogos de mesa) e **Grande Prêmio do Mês**. Prêmio em fichas pros 10 primeiros de cada um.

A pontuação segue o mesmo princípio do resto: **nada aqui empurra a pessoa a gastar mais**. Cada rodada vale pontos proporcionais ao que voltou em relação ao que foi apostado — dobrar a aposta vale +100 pontos, apostando 10 fichas ou 10.000 dá exatamente o mesmo. Pontuar pelo saldo líquido, como seria mais fácil, faria o topo do ranking virar a lista de quem apostou mais alto (quem aposta 5.000 oscila cem vezes mais que quem aposta 50, e o topo de um ranking é a ponta de cima dessa oscilação). Cada torneio também exige um mínimo de rodadas, pra uma única sorte grande não travar a competição inteira.

A regra aparece escrita na tela de torneios, do mesmo jeito que o RTP aparece na tela de cada jogo.
...
4. **Poker multiplayer.** O único jogo de mesa que continua só contra bot — mesa de 2 a 9 lugares com side pot é bem mais trabalho que o 2x2 de assento fixo.
5. **Planilha de economia** (curva de nível, preço dos pacotes) — documento de negócio, não código.
